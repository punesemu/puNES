...
BYTE stateOperation(BYTE mode, BYTE slot, FILE *fp) {
	...
	savestateEle(mode, slot, DMC.irqEnabled)
	savestateEle(mode, slot, DMC.loop)
	savestateEle(mode, slot, DMC.rateIndex)
	savestateEle(mode, slot, DMC.addressStart)
	...
	savestateEle(mode, slot, DMC.dmaCycle)
	savestateEle(mode, slot, DMC.silence)
	savestateEle(mode, slot, DMC.shift)
	savestateEle(mode, slot, DMC.counterOut)
	savestateEle(mode, slot, DMC.output)
	savestateEle(mode, slot, DMC.tickType)
