...
static const _settings inp_cfg[] = {
	...
	{uL("shortcuts"), uL("shout into microphone"),         uL("C,NULL"),            NULL, NULL, {0, NULL}},
	...
	{uL("shortcuts"), uL("toggle capture input"),          uL("CTRL+Alt+Z,NULL"),   NULL, NULL, {0, NULL}},
	{uL("shortcuts"), uL("toggle virtual keyboard"),       uL("CTRL+Alt+X,NULL"),   NULL, NULL, {0, NULL}},
