...
EXTERNC BYTE gfx_monitor_set_res(int w, int h, BYTE adaptive_rrate, BYTE is_change_mode);
EXTERNC BYTE gfx_monitor_restore_res(void);
EXTERNC void gfx_monitor_mode_in_use_resolutions(int *w, int *h, int *rrate);
