...
void scale_2xsai(void) {
	scaler_2xsai((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_dotmatrix(void) {
	scaler_dotmatrix((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_paltv1x(void) {
	scaler_paltv1x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_paltv2x(void) {
	scaler_paltv2x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_paltv3x(void) {
	scaler_paltv3x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_paltv4x(void) {
	scaler_paltv4x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_super2xsai(void) {
	scaler_super2xsai((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_supereagle(void) {
	scaler_supereagle((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_tv2x(void) {
	scaler_tv2x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_tv3x(void) {
	scaler_tv3x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
void scale_tv4x(void) {
	scaler_tv4x((BYTE *)ppudata.ppu_screen.rd->data, (BYTE *)gfx.filter.data.pix, gfx.filter.data.pitch, SCR_COLUMNS, SCR_ROWS,
		(uint32_t *)gfx.filter.data.palette);
}
