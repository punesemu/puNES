...
void scaleNx(void) {
	...
	if (gfx.filter.factor == 2) {
		scale2x(ppudata.ppu_screen.rd->line, (uint32_t *)gfx.filter.data.palette, gfx.filter.data.pitch, gfx.filter.data.pix);
	} else if (gfx.filter.factor == 3) {
		scale3x(ppudata.ppu_screen.rd->line, (uint32_t *)gfx.filter.data.palette, gfx.filter.data.pitch, gfx.filter.data.pix);
		...
		scale4x(ppudata.ppu_screen.rd->line, (uint32_t *)gfx.filter.data.palette, gfx.filter.data.pitch, gfx.filter.data.pix);
	}
}
