...
static INLINE uint32_t Interpolate_2(uint32_t c1, int w1, uint32_t c2, int w2, int s) {
	...
	return (((((c1 & MASK_ALPHA) >> 24) * w1 + ((c2 & MASK_ALPHA) >> 24) * w2) << (24 - s))
			& MASK_ALPHA) + ((((c1 & MASK_2) * w1 + (c2 & MASK_2) * w2) >> s) & MASK_2)
			+ ((((c1 & MASK_13) * w1 + (c2 & MASK_13) * w2) >> s) & MASK_13);
}
static INLINE uint32_t Interpolate_3(uint32_t c1, int w1, uint32_t c2, int w2, uint32_t c3, int w3,
		int s) {
	return (((((c1 & MASK_ALPHA) >> 24) * w1 + ((c2 & MASK_ALPHA) >> 24) * w2
...
#if defined _HQ2X_ || defined _HQ3X_ || defined _HQ4X_
...
#if defined _HQ3X_ || defined _HQ4X_
...
#if defined _HQ2X_ || defined _HQ4X_
