...
void prg_swap_jyasic_397(WORD address, DBWORD value);
void chr_swap_jyasic_397(WORD address, DBWORD value);
void wram_swap_jyasic_397(WORD address, DBWORD value);
void mirroring_swap_jyasic_397(WORD address, DBWORD value);

INLINE static DBWORD prg_bank(DBWORD value);
INLINE static DBWORD chr_bank(DBWORD value);

void map_init_397(void) {
	...
	JYASIC_prg_swap = prg_swap_jyasic_397;
	JYASIC_chr_swap = chr_swap_jyasic_397;
	JYASIC_wram_swap = wram_swap_jyasic_397;
	JYASIC_mirroring_swap = mirroring_swap_jyasic_397;
}
...
INLINE static DBWORD chr_bank(DBWORD value) {
	return (((jyasic.mode[3] << 7) | (value & 0x7F)));
}
