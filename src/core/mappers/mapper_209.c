...
void prg_swap_jyasic_209(WORD address, DBWORD value);
void chr_swap_jyasic_209(WORD address, DBWORD value);
void wram_swap_jyasic_209(WORD address, DBWORD value);
void mirroring_swap_jyasic_209(WORD address, DBWORD value);

INLINE static DBWORD prg_bank(DBWORD value);
INLINE static DBWORD chr_bank(DBWORD value);

void map_init_209(void) {
	...
	JYASIC_mirroring_swap = mirroring_swap_jyasic_209;
}
...
INLINE static DBWORD prg_bank(DBWORD value) {
	return (((jyasic.mode[3] << 5) & ~0x3F) | (value & 0x3F));
}
INLINE static DBWORD chr_bank(DBWORD value) {
