...
void prg_swap_mmc3_47(WORD address, WORD value);
void chr_swap_mmc3_47(WORD address, WORD value);
...
void map_init_47(void) {
	...
	init_MMC3();
	MMC3_prg_swap = prg_swap_mmc3_47;
	MMC3_chr_swap = chr_swap_mmc3_47;
