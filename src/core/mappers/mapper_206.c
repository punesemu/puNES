...
void prg_swap_n118v2_206(WORD address, WORD value);
void chr_swap_n118v2_206(WORD address, WORD value);
...
void map_init_206(void) {
	...
	init_N118v2();
	N118v2_prg_swap = prg_swap_n118v2_206;
	N118v2_chr_swap = chr_swap_n118v2_206;
}
