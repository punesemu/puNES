...
void prg_swap_jyasic_358(WORD address, DBWORD value);
void chr_swap_jyasic_358(WORD address, DBWORD value);
void wram_swap_jyasic_358(WORD address, DBWORD value);
void mirroring_swap_jyasic_358(WORD address, DBWORD value);

INLINE static DBWORD prg_bank(DBWORD value);
INLINE static DBWORD chr_bank(DBWORD value);

void map_init_358(void) {
	...
	init_JYASIC(TRUE);
	JYASIC_prg_swap = prg_swap_jyasic_358;
	JYASIC_chr_swap = chr_swap_jyasic_358;
	JYASIC_wram_swap = wram_swap_jyasic_358;
	JYASIC_mirroring_swap = mirroring_swap_jyasic_358;
}
