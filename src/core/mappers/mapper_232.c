...
void map_init_232(void) {
	...
	mapper.internal_struct[0] = (BYTE *)&m232;
	mapper.internal_struct_size[0] = sizeof(m232);
...
void extcl_cpu_wr_mem_232(WORD address, BYTE value) {
...
INLINE static void prg_fix_232(void) {
	memmap_auto_16k(MMCPU(0x8000), (m232.reg[0] | m232.reg[1]));
	memmap_auto_16k(MMCPU(0xC000), (m232.reg[0] | 0x03));
}
