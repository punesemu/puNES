...
void prg_swap_191(WORD address, WORD value);
void chr_swap_191(WORD address, WORD value);
...
void map_init_191(void) {
	...
	init_MMC3();
	MMC3_prg_swap = prg_swap_191;
	MMC3_chr_swap = chr_swap_191;
