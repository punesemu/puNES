...
void prg_fix_n118v2_307(void);
void chr_fix_n118v2_307(void);
void chr_swap_n118v2_307(WORD address, WORD value);
...
void map_init_307(void) {
	...
	init_N118v2();
	N118v2_prg_fix = prg_fix_n118v2_307;
	N118v2_chr_fix = chr_fix_n118v2_307;
	N118v2_chr_swap = chr_swap_n118v2_307;
...
void chr_fix_n118v2_307(void) {
	chr_fix_N118v2_base();
	map_nmt_1k(0, (n118v2.reg[2] & 0x01));
	map_nmt_1k(1, (n118v2.reg[4] & 0x01));
	map_nmt_1k(2, (n118v2.reg[3] & 0x01));
	map_nmt_1k(3, (n118v2.reg[5] & 0x01));
}
void chr_swap_n118v2_307(WORD address, WORD value) {
