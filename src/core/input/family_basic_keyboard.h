...
void input_wr_family_basic_keyboard(BYTE cidx, const BYTE *value, BYTE nport);
void input_rd_family_basic_keyboard(BYTE cidx, BYTE *value, BYTE nport, BYTE shift);
